print("<DESCRIPTION>Test description :-  This test run for Amplitude modulation of a given different carrier signal, baseband frequency and deviation</DESCRIPTION>")
###########################
###START OF SCRIPT###
