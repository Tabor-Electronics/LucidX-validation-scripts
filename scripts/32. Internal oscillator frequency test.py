...
for r_freq in [100e6,10e6]:
    ...
    if config.spectrum:
        spectrum_methods.set_reference_power(12, spectrum_analyzer)
        spectrum_methods.set_centre_frequency(r_freq/1e6, spectrum_analyzer)
        spectrum_methods.set_span_freq(100, spectrum_analyzer)
        spectrum_methods.set_centre_frequency(r_freq / 1e6, spectrum_analyzer)
